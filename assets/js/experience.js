...
const exp = [
  ...
  {
    title: "IT HOLIC Hackathon Version 2",
  ...
  },
  {
    ...
    time: "(July - Sept, 2022)",
    desp: "<li>I recently worked on a team to reverse engineer the Amazon inventory reconciliation project using artificial intelligence.</li><li> We used computer vision and image recognition algorithms to process images of physical items to count and identify them.</li><li>This allowed us to accurately monitor and reconcile inventory levels across all locations, ensuring that all items were accounted for and correctly identified.</li><li> We also developed the AI technology to be robust and adaptive in order to improve accuracy in inventory tracking and management.</li>",
  },
