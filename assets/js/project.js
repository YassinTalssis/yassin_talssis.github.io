...
const projects = [
  ...
  },
  {
    ...
    description: "This project focused on recognizing hand finger gestures using surface Electromyography (sEMG). My contributions included:<li>signal processing through the application of Fast Fourier Transform.</li><li>Developing deep learning models, including architectures such as RNN and LSTM.</li><li>Train/test/validate/compare models.</li>",
